  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="border-t border-border px-2 py-2 space-y-0.5">
        <FooterLink to="/" icon={Monitor} label="Fleet" />
        <FooterLink to="/stats" icon={BarChart3} label="Stats" />
        <a
          href="https://github.com/rahul-roy-glean/conductor"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-3 py-2 rounded-sm text-sm text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors"
        >
          <svg
            viewBox="0 0 16 16"
            fill="currentColor"
      ...
      <QuickTask open={quickTaskOpen} onOpenChange={setQuickTaskOpen} />
    </div>
  );
}
